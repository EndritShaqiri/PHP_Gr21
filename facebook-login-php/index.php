...
<?php if(isset($_SESSION['fb_user_id'])): ?>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  ...
	  <div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
		  <li class="nav-item">
			<a class="nav-link" href="https://youtube.com"><i class="fa fa-youtube"> Youtube Soon ...</i></a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="https://www.facebook.com"><i class="fa fa-facebook">acebook</i></a>
		  </li>
		  <li class="nav-item">
	...
	<div class="container" style="margin-top:30px">
	  <div class="row">
		...
		<div class="col-sm-8">
		  ...
		  <form>
             <button><a class="nav-link" href="../admin/index.php"> Vazhdo ne portal pasi je kycur me facebook</a></button>
		  </form>
