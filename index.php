...
<html lang="en">
	...
	<body>
	 ...
	 <nav class="navbar navbar-dark sticky-top bg-dark p-3 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Dardania</a>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <h6>Pershendetje <?php echo $_SESSION['author_name']; ?> | Roli juaj eshte <?php echo $_SESSION['author_role']; ?></h6>
          </div>
